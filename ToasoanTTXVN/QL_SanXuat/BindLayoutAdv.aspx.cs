...
{
    public partial class BindLayoutAdv : System.Web.UI.Page
    {
        private int mabao = 0;
        private int trang = 0;
            ...
            try
            {
                ...
                if (tb.Rows.Count > 0)
                {
                    for (int i = 0; i < tb.Rows.Count; i++)
                    {
                        ...
                        if (mrow["Ma_Congviec"].ToString() == "0" && mrow["Ma_Tinbai"].ToString() == "0")
                        {
                            ...
                            bd.Append("<input type=\"button\" id=\"btnAdvertis\" class=\"btnAdvertis\" value=\"Chọn quảng cáo\" onclick=\"ChonAdv(this,'" + mrow["Ma_Vitri"] + "');\"/>");
