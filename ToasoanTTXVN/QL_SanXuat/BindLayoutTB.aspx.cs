...
{
    public partial class BindLayoutTB : System.Web.UI.Page
    {
        private int mabao = 0;
        private int trang = 0;
            ...
            try
            {
                ...
                if (tb.Rows.Count > 0)
                {
                    for (int i = 0; i < tb.Rows.Count; i++)
                    {
                        ...
                        if (mrow["Ma_Tinbai"].ToString() != "0" && mrow["Ma_Congviec"].ToString() == "0")
                        {
                            ...
                            bd.Append("<input type=\"button\" id=\"btnremoveItem\" class=\"btnremoveChild\" value=\"Xóa\" onclick=\"return removeDivChild('" + mrow["Ma_Vitri"] + "');\"/>");
                            bd.Append("<input type=\"button\" id=\"ChonTinBai\" class=\"btnChontinbai\" value=\"Chọn tin bài\" onclick=\"Chonbaiviet(this,'" + mrow["Ma_Vitri"] + "');\"/>");
                        ...
                        else if (mrow["Ma_Congviec"].ToString() != "0" && mrow["Ma_Tinbai"].ToString() != "0")
                        {
