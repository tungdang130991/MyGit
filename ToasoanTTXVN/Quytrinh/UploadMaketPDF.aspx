<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ITC.Master" AutoEventWireup="true"
    CodeBehind="UploadMaketPDF.aspx.cs" Inherits="ToasoanTTXVN.Quytrinh.UploadMaketPDF" %>
    ...
    function() {
        ...
        function LoadFileUpload() {
            ...
            $("#<%=FileUploadPDF.ClientID %>").uploadify({
                ...
                'uploader': '../UploadFileMulti/UploadFilePDF.ashx?user=<%=GetUserName()%> ' + ',' + $('#<%=cboPage.ClientID%>').val() + ',' + $('#<%=cboSoBao.ClientID%>').val() + ',' + 1,
                'auto': true,
                'multi': true,
                'folder': 'Upload',
