<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ITC.Master" AutoEventWireup="true"
    CodeBehind="List_PV.aspx.cs" Inherits="ToasoanTTXVN.Quytrinh.List_PV" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table border="0" cellpadding="0" width="100%" cellspacing="0">
        <tr>
            <td style="text-align: center; fon">
                <div class="divPanelSearch">
                    <div style="width: 99%; padding: 5px 0.5%">
                        <table border="0" cellpadding="2" cellspacing="2" width="100%">
                            ...
                            <tr>
                                ...
                                <td style="width: 10%; text-align: left">
                                    <asp:UpdatePanel ID="UpdatePanel_SB" runat="server">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="cboSoBao" runat="server" Width="100%" CssClass="inputtext" AutoPostBack="true" OnSelectedIndexChanged="cboSoBao_OnSelectedIndexChanged"
                                                TabIndex="5">
                                            </asp:DropDownList>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                ...
                                <td style="width: 10%; text-align: left; vertical-align: middle">
                                    <asp:TextBox ID="txt_tungay" runat="server" Width="110px" CssClass="inputtext" MaxLength="10"
                                    ...
                                    <asp:RegularExpressionValidator ID="Regularexpressionvalidator3" runat="server" ControlToValidate="txt_tungay"
                                        ValidationExpression="^\d{1,2}/\d{1,2}/\d{4}$" Display="Dynamic">(dd/MM/yyyy)</asp:RegularExpressionValidator>&nbsp;&nbsp;
                                </td>
                                <td style="width: 10%; text-align: left">
                            ...
                            <tr>
                                <td style="text-align: center; width: 15%" colspan="7">
                        ...
                        <ContentTemplate>
                            <div style="text-align: left; width: 100%; vertical-align: top">
                                <cc2:TabContainer ID="TabContainer1" runat="server" CssClass="ajax__tab_yuitabview-theme"
                                    ...
                                    <cc2:TabPanel HeaderText="<%$Resources:cms.language, lblTinbientap%>" ID="TabPanelDangxuly"
                                        runat="server">
                                        <ContentTemplate>
                                            <table border="0" style="width: 100%">
                                                <tr>
                                                    <td>
                                                        <asp:DataGrid ID="DataGrid_Dangxuly" runat="server" Width="100%" AutoGenerateColumns="False"
                                                            ...
                                                            OnItemDataBound="DataGrid_ItemDataBound" OnEditCommand="DataGrid_EditCommand">
                                    ...
                                    <cc2:TabPanel HeaderText="<%$Resources:cms.language, lblTintralai%>" ID="TabPanelTinTraLai"
                                        runat="server">
                                        <ContentTemplate>
                                            <table border="0" style="width: 100%">
                                                <tr>
                                                    <td>
                                                        <asp:DataGrid ID="DataGrid_TinTraLai" runat="server" Width="100%" AutoGenerateColumns="False"
                                                            CssClass="Grid" BorderColor="#7F8080" CellPadding="0" DataKeyField="Ma_Tinbai"
                                                            OnItemDataBound="DataGrid_ItemDataBound" BorderStyle="None" BackColor="White"
                                                            BorderWidth="1px" AlternatingItemStyle-BackColor="#F1F1F2" OnEditCommand="DataGrid_EditCommand">
                                                            <ItemStyle CssClass="GridItem"></ItemStyle>
                                                            <AlternatingItemStyle CssClass="GridAltItem" />
                                                            <HeaderStyle CssClass="GridHeader"></HeaderStyle>
                                                            <Columns>
                                    ...
                                    <cc2:TabPanel HeaderText="<%$Resources:cms.language, lblMaketpdf%>" ID="TabPanelMaketPDF"
                                        runat="server">
                                        <ContentTemplate>
                                ...
                                <asp:Panel ID="pnlbutton" runat="server">
                                    <table border="0" style="width: 100%">
                                        <tr>
                                            ...
                                            <td style="text-align: left; float: left; width: 95%">
                                                <asp:DataList ID="DataListDoiTuong" runat="server" OnItemCommand="DataListDoiTuong_ItemCommand"
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkdoituong" runat="server" CssClass="iconSend" CommandName="cmd"
                                                            OnClientClick=" return confirm('Bạn chắc chắn muốn gửi tin bài?');" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"Ma_DoiTuong")%>'
                                                            Text='<%# Bind("ThaoTac")%>'>
                                                        </asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:DataList>
                            ...
                            <div style="text-align: right; float: right" class="pageNav">
                                ...
                                <cc1:Pager runat="server" ID="Pager7" OnIndexChanged="Pager_IndexChanged">
                                </cc1:Pager>
                            </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
