<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ITC.Master" AutoEventWireup="true"
    CodeBehind="DeskList.aspx.cs" Inherits="ToasoanTTXVN.Quytrinh.DeskList" %>
                                    ...
                                    <ContentTemplate>
                                        <div style="text-align: left; width: 100%">
                                            <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" CssClass="ajax__tab_yuitabview-theme"
                                                ...
                                                <ajaxToolkit:TabPanel HeaderText="<%$Resources:cms.language, lblTinbaigac%>" ID="TabPanelBaiGac"
                                                    runat="server">
                                                    <ContentTemplate>
                                                        <table border="0" style="width: 100%">
                                                            <tr>
                                                                <td>
                                                                    <asp:DataGrid ID="DataGrid_BaiGac" runat="server" Width="100%" BorderStyle="None"
                                                                        AutoGenerateColumns="False" BorderColor="#d4d4d4" CellPadding="0" DataKeyField="Ma_Tinbai"
                                                                        BackColor="White" CssClass="Grid" BorderWidth="1px" AlternatingItemStyle-BackColor="#F1F1F2"
                                                                        OnEditCommand="DataGrid_EditCommand" OnItemDataBound="DataGrid_OnItemDataBound">
                                                                        <ItemStyle CssClass="GridItem"></ItemStyle>
                                                ...
                                                <ajaxToolkit:TabPanel HeaderText="<%$Resources:cms.language, lblTintralai%>" ID="TabPanelThungrac"
                                                    runat="server">
                                                    <ContentTemplate>
                                                        <table border="0" style="width: 100%">
                                                            <tr>
                                                    ...
                                                    <tr>
                                                        <td style="text-align: left; float: left; width: 100%">
                                                            ...
                                                            <asp:LinkButton runat="server" ID="LinkBack" CausesValidation="false" OnClick="SendBack_Click"
                                                                ...
                                                                Visible="False" CssClass="iconBack"> </asp:LinkButton>
                                                            <asp:LinkButton runat="server" ID="Linkbaigac" CausesValidation="false" OnClick="Linkbaigac_Click"
                                                                OnClientClick=" return confirm('Bạn chắc chắn gác lại?');" Text="<%$Resources:cms.language, lblTinbaigac%>"
                                                                CssClass="iconBack"> </asp:LinkButton>
                                                            <asp:DataList ID="DataListDoiTuong" runat="server" OnItemCommand="DataListDoiTuong_ItemCommand"
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lnkdoituong" runat="server" CssClass="iconSend" CommandName="cmd"
                                                                        OnClientClick=" return confirm('Bạn chắc chắn gửi tin bài?');" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"Ma_DoiTuong")%>'
                                                                        Text='<%# Bind("ThaoTac")%>'>
                                                                    </asp:LinkButton>
                                                                </ItemTemplate>
                                                            </asp:DataList>
