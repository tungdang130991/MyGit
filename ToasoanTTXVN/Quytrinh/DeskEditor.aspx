<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ITC.Master" AutoEventWireup="true"
    CodeBehind="DeskEditor.aspx.cs" Inherits="ToasoanTTXVN.Quytrinh.DeskEditor" %>
                        ...
                        <table cellspacing="4" cellpadding="4" width="100%" border="0">
                            ...
                            <tr>
                                <td style="vertical-align: top; width: 100%;">
                                    <table cellspacing="4" cellpadding="4" width="100%" border="0">
                                        <tr>
                                            <td style="text-align: left" class="Titlelbl" colspan="3">
                                                <span>
                                        ...
                                        <tr>
                                            <td style="width: 20%; text-align: left">
                                                <asp:UpdatePanel ID="UpdatePanelAnpham" runat="server">
                                                    <ContentTemplate>
                                        ...
                                        <tr>
                                            <td style="text-align: center; width: 100%" colspan="3">
                                                <div style="float: left; width: 30%; text-align: right;">
                                                    <img style="cursor: pointer" src="../Dungchung/Images/preview.png" alt='' onclick="Javascript:open_window_reviewScroll();" />
                                                </div>
                                                <div style="float: left; width: 70%; text-align: left;">
                                                    ...
                                                    <asp:LinkButton runat="server" ID="LinkBaiGac" CssClass="iconBack" TabIndex="19"
                                                        CausesValidation="false" OnClick="LinkBaiGac_Click" Text="<%$ Resources:cms.language, lblTinbaigac %>"></asp:LinkButton>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanelXoaIMG" runat="server">
                                                        <ContentTemplate>
                                                            <asp:Button runat="server" ID="btnXoaAnh" TabIndex="21" CssClass="iconDel" Text="<%$Resources:cms.language, lblXoa%>"
                                                                OnClientClick="confirm('Do you want to delete?');" CausesValidation="false" OnClick="btnXoaAnh_Click">
                                                            </asp:Button>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
