<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ITC.Master" AutoEventWireup="true"
    CodeBehind="ChiefList.aspx.cs" Inherits="ToasoanTTXVN.Quytrinh.ChiefList" %>
                                    ...
                                    <ContentTemplate>
                                        <div style="text-align: left; width: 100%">
                                            <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" CssClass="ajax__tab_yuitabview-theme"
                                                ...
                                                <ajaxToolkit:TabPanel HeaderText="<%$Resources:cms.language, lblTinmoi%>" ID="tabpnltinChoXuly"
                                                    ...
                                                    <ContentTemplate>
                                                        <table border="0" style="width: 100%">
                                                            <tr>
                                                                <td>
                                                                    <asp:DataGrid ID="DataGrid_TinMoi" runat="server" Width="100%" BorderStyle="None"
                                                ...
                                                <ajaxToolkit:TabPanel HeaderText="<%$Resources:cms.language, lblTinbientap%>" ID="TabPanelDangxuly"
                                                    ...
                                                    <ContentTemplate>
                                                        <table border="0" style="width: 100%">
                                                            <tr>
                                                                <td>
                                                                    <asp:DataGrid ID="DataGrid_TinDangXuLy" runat="server" Width="100%" AutoGenerateColumns="False"
                                                ...
                                                <ajaxToolkit:TabPanel HeaderText="<%$Resources:cms.language, lblTintralai%>" ID="TabPanelTinTraLai"
                                                    ...
                                                    <ContentTemplate>
                                                        <table border="0" style="width: 100%">
                                                            <tr>
                                                                <td>
                                                                    <asp:DataGrid ID="DataGrid_TinTralai" runat="server" Width="100%" AutoGenerateColumns="False"
                                                                        CssClass="Grid" BorderColor="#7F8080" CellPadding="0" DataKeyField="Ma_Tinbai"
                                                                        BorderStyle="None" BackColor="White" BorderWidth="1px" AlternatingItemStyle-BackColor="#F1F1F2"
                                                                        OnItemDataBound="DataGrid_OnItemDataBound" OnEditCommand="DataGrid_EditCommand">
                                                                        <ItemStyle CssClass="GridItem"></ItemStyle>
                                                ...
                                                <ajaxToolkit:TabPanel HeaderText="<%$Resources:cms.language, lblTindagui%>" ID="TabPanelTinDaXuLy"
                                                    ...
                                                    <ContentTemplate>
                                                        <table border="0" style="width: 100%">
                                                            <tr>
                                                                <td>
                                                                    <asp:DataGrid ID="DataGrid_TinDaXuLy" runat="server" Width="100%" AutoGenerateColumns="False"
                                                ...
                                                <ajaxToolkit:TabPanel HeaderText="<%$Resources:cms.language, lblThungrac%>" ID="TabPanelThungrac"
                                                    ...
                                                    <ContentTemplate>
                                                        <table border="0" style="width: 100%">
                                                            <tr>
                                                                <td>
                                                                    <asp:DataGrid ID="DataGrid_Thungrac" runat="server" Width="100%" BorderStyle="None"
                                                                        AutoGenerateColumns="False" BorderColor="#d4d4d4" CellPadding="0" DataKeyField="Ma_Tinbai"
                                                                        BackColor="White" CssClass="Grid" BorderWidth="1px" AlternatingItemStyle-BackColor="#F1F1F2"
                                                                        OnEditCommand="DataGrid_EditCommand" OnItemDataBound="DataGrid_OnItemDataBound">
                                                                        <ItemStyle CssClass="GridItem"></ItemStyle>
                                                ...
                                                <ajaxToolkit:TabPanel HeaderText="<%$Resources:cms.language, lblTinChoDanTrang%>"
                                                    ID="TabPanelTinXuatBan" runat="server">
                                                    <ContentTemplate>
                                                        <table border="0" style="width: 100%">
                                                            <tr>
                                                                <td>
                                                                    <asp:DataGrid ID="DataGrid_TinXuatBan" runat="server" Width="100%" BorderStyle="None"
                                                                        AutoGenerateColumns="False" BorderColor="#d4d4d4" CellPadding="0" DataKeyField="Ma_Tinbai"
                                                                        BackColor="White" CssClass="Grid" BorderWidth="1px" AlternatingItemStyle-BackColor="#F1F1F2"
                                                                        OnEditCommand="DataGrid_EditCommand" OnItemDataBound="DataGrid_OnItemDataBound">
                                                                        <ItemStyle CssClass="GridItem"></ItemStyle>
                                                ...
                                                <ajaxToolkit:TabPanel HeaderText="Duyệt Layout PDF" ID="TabPanelMaketPDF" runat="server">
                                                    <ContentTemplate>
                                                        <div style="text-align: left; width: 100%; float: left">
                                                            <asp:Label ID="lblMessage" runat="server" CssClass="TitleHeader" ForeColor="Red"
                                                                Text="Đã duyệt layout" Visible="false"></asp:Label></div>
                                                        <div style="text-align: left; width: 100%; float: left">
                                                            <asp:DataList ID="DataGrid_FilePDF" runat="server" RepeatColumns="10" RepeatDirection="Horizontal"
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <div style="width: 90%; float: left; text-align: center">
                                                                        <asp:ImageButton ID="Imagebuttondelete" OnClientClick="confirm('Bạn chắc chắn duyệt?');"
                                                                            Style="width: 20px; height: 20px; cursor: poiter" CausesValidation="false" runat="server"
                                                                            ImageUrl="../Dungchung/Images/ok-icon.png" ImageAlign="AbsMiddle" ToolTip="Duyệt layout"
                                                                            CommandName="Edit" CommandArgument="Ok" BorderStyle="None" Visible='<%#VisibleImgButton(Eval("Status"),1)%>'>
                                                                        </asp:ImageButton>&nbsp;&nbsp;
                                                                        <asp:ImageButton ID="Imagebuttonundo" OnClientClick="confirm('Bạn chắc hủy duyệt?');"
                                                                            Style="width: 20px; height: 20px; cursor: poiter" CausesValidation="false" runat="server"
                                                                            ImageUrl="../Dungchung/Images/undo.png" ImageAlign="AbsMiddle" ToolTip="Undo"
                                                                            CommandName="Edit" CommandArgument="Undo" BorderStyle="None" Visible='<%#VisibleImgButton(Eval("Status"),2)%>'>
                                                                        </asp:ImageButton>&nbsp;&nbsp;
                                                                        <asp:ImageButton ID="ImagebuttonReply" Style="width: 20px; height: 20px; cursor: poiter"
                                                                            ...
                                                                            BorderStyle="None" Visible='<%#VisibleImgButton(Eval("Status"),1)%>'></asp:ImageButton>
                                                                    </div>
                                                                </ItemTemplate>
                                                            </asp:DataList>
                                                        </div>
                                                        <div style="text-align: left; width: 100%; float: left">
                                                            <asp:Button ID="btnphanhoilayoutPDF" runat="server" CssClass="iconBack" Text="Phản hồi cho họa sỹ"
                                                                OnClick="btnphanhoilayoutPDF_Clik" Visible="False" />
                                                            <asp:Button ID="btnduyetlayoutPDF" runat="server" CssClass="iconSend" Text="Duyệt layout PDF"
                                                                OnClick="btnduyetlayoutPDF_Clik" Visible="False" />
                                                        </div>
                                                    </ContentTemplate>
                                                </ajaxToolkit:TabPanel>
