<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ITC.Master" AutoEventWireup="true"
    CodeBehind="Reporter.aspx.cs" Inherits="ToasoanTTXVN.Quytrinh.Reporter" %>
                ...
                <div class="divPanelResult">
                    <div style="width: 99%; float: left; padding: 5px 0.5%">
                        <table cellspacing="4" cellpadding="4" width="100%" border="0">
                            <tr>
                                <td style="text-align: center; width: 100%; font-size: 16px;" colspan="3">
                                    <asp:Label ID="lblMsg" runat="server" ForeColor="Red" Text=""></asp:Label>
                                    <asp:Label ID="ErrorMesages" runat="server" Style="font-family: Arial; font-size: medium;
                                        color: Red"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="text-align: left; width: 100%">
                                    <asp:TextBox ID="Txt_tieude" TabIndex="4" Width="98%" runat="server" CssClass="inputtext"></asp:TextBox>
                                        ...
                                        <tr>
                                            <td style="text-align: center; width: 100%" colspan="3">
                                                <div style="float: left; width: 30%; text-align: right;">
                                                    <img style="cursor: pointer" src="../Dungchung/Images/preview.png" alt='' onclick="open_window_reviewScroll();" />
                                                </div>
                                                <div style="float: left; width: 70%; text-align: left;">
                                                    <asp:LinkButton runat="server" ID="linkSave" CssClass="iconSave" CausesValidation="true"
                                                        TabIndex="17" OnClick="linkSave_Click" OnClientClick="validateText();" Text="<%$ Resources:cms.language, lblLuu %>">
                                                    </asp:LinkButton>
