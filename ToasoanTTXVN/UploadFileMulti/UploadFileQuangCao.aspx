<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadFileQuangCao.aspx.cs"
    Inherits="ToasoanTTXVN.UploadFileMulti.UploadFileQuangCao" %>
...
<body style="margin-top: 5px; margin-left: 5px; margin-right: 5px; margin-bottom: 5px">
    <form id="formuploadfilequangcao" method="post" enctype="multipart/form-data" runat="server">
...
<script type="text/javascript">
    ...
    function() {
        $("#<%=FileUpload1.ClientID %>").fileUpload({
            ...
            'script': '../UploadFileMulti/UploadFileQuangcao.ashx',
            'folder': 'QuangCao',
            'fileDesc': 'All Files',
            ...
            'auto': true,
            'onComplete': function() {
                var url = '<%=Global.ApplicationPath %>/UploadFileMulti/UploadFileQuangCao.aspx';
                window.location = url;
            }
        });
    }
