<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ITC.Master" AutoEventWireup="true"
    CodeBehind="Taichinhthanhtoannhuanbut_Tinbai.aspx.cs" Inherits="ToasoanTTXVN.Nhuanbut.Taichinhthanhtoannhuanbut_Tinbai" %>
                        ...
                        <asp:DataGrid ID="DataGrid_tinbai" runat="server" Width="100%" BorderStyle="None"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn>
                                    ...
                                    <ItemTemplate>
                                        <span class="linkGridForm">
                                            <%#HPCBusinessLogic.UltilFunc.GetUserFullName(Eval("NGUOI_THANHTOAN"))%></span>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                <asp:TemplateColumn>
                                    <HeaderStyle HorizontalAlign="Center" Width="10%"></HeaderStyle>
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblNgayTT" CssClass="linkGridForm" runat="server" Text='<%#DataBinder.Eval(Container, "DataItem.NGAY_THANHTOAN")!=System.DBNull.Value?Convert.ToDateTime( DataBinder.Eval(Container.DataItem, "NGAY_THANHTOAN")).ToString("dd/MM/yyyy"):""%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                <asp:TemplateColumn>
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton ID="btnThanhtoan" runat="server" ImageUrl='<%#IsThanhtoan(DataBinder.Eval(Container.DataItem, "THANHTOAN"))%>'
                                            Width="25px" Height="25px" ImageAlign="AbsMiddle" ToolTip="Thanh toán" CommandName="Edit"
