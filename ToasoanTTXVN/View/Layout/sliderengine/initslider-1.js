jQuery(document).ready(function() {
    ...
    jQuery("#amazingslider-1").amazingslider({
        ...
        descriptioncss: "display:block; position:relative; color:#fff; margin-top:8px;",
        ...
        navbordercolor: "#05536a",
        navpreviewarrowimage: "previewarrow-8-16-0.png",
        navthumbtitlecss: "display:block;position:relative;padding:2px 4px;text-align:center;color:#333;",
