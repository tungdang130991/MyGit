...
namespace HPCApplication.ckeditor.plugins.insert_image
{
    ...
    public class UploadImgEditor : IHttpHandler
    {
            ...
            try
            {
                ...
                if (_extenfile.ToLower() != ".flv" && _extenfile.ToLower() != ".swf" && _extenfile.ToLower() != ".mp3" && _extenfile.ToLower() != ".mp4" && _extenfile.ToLower() != ".wmv" && _extenfile.ToLower() != ".doc" && _extenfile.ToLower() != ".docx" && _extenfile.ToLower() != ".xls" && _extenfile.ToLower() != ".rar" && _extenfile.ToLower() != ".txt" && _extenfile.ToLower() != ".pdf")
                {
                    ...
                    if (WaterMark > 0)
                    {
                        ...
                        HPCImageResize.SaveImage2Server(savepath, filename, "mark_" + _imagesEndWatermark, _imagesEndWatermark, _logo, Convert.ToInt32(HPCComponents.Global.VNPResizeImagesContent), Convert.ToInt32(HPCComponents.Global.VNPResizeImagesContent), WaterMark, spacevalue);
                    }
                    else
                        HPCImageResize.SaveImage2Server(savepath, filename, _imagesEndWatermark, Convert.ToInt32(HPCComponents.Global.VNPResizeImagesContent), Convert.ToInt32(HPCComponents.Global.VNPResizeImagesContent));
