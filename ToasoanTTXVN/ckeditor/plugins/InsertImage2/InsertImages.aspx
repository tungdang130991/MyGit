<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsertImages.aspx.cs" Inherits="HPCApplication.ckeditor.plugins.InsertImage2.InsertImages" %>
                                ...
                                <tr>
                                    <td style="text-align: left; width: 20%">
                                        <input type="button" id="btn_OkInsert" class="iconPub" style="height: 35px; width: 120px;
                                            background-color: #cccccc; margin-bottom: 10px;" value="Chọn ảnh" onclick="Send_ImagesMulti();" />
                                    </td>
...
<script type="text/javascript">
    ...
    function run_upload() {
        ...
        $("#<%=FileUpload1.ClientID %>").uploadify({
            ...
            'uploader': '../insert_image/UploadImgEditor.ashx?user=<%=GetUserName()%>&watermark=' + str + '&inStock=0',// + _strStock,
            'folder': 'Upload',
