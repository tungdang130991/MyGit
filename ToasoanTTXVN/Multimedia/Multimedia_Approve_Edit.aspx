<%@ Page Language="C#" MasterPageFile="~/Masters/ITC.Master" AutoEventWireup="true"
    CodeBehind="Multimedia_Approve_Edit.aspx.cs" Inherits="ToasoanTTXVN.Multimedia.Multimedia_Approve_Edit"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script language="Javascript" type="text/javascript">
        function BrowserVideoFile(vKey) {
            //SubmitImage('../UploadFileMulti/Videos_Managerment.aspx?vType=3&vKey=' + vKey + '', 840, 580);
        ...
        <tr>
            ...
            <td style="text-align: center">
                <table width="80%" align="center" cellspacing="2" cellpadding="2">
                    ...
                    <tr>
                        <td style="text-align: right" class="Titlelbl">
                            <%= CommonLib.ReadXML("lblĐuonganvideo") %>: <span class="req_Field">*</span>
                        </td>
                        <td style="text-align: left">
                            ...
                            <input class="PhotoSel" accesskey="S" onclick="BrowserVideoFile(2)" type="button"
                                value="Browse" name="cmd_SavePath2" /><asp:TextBox ID="txtVideoID" Width="10" runat="server"
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;">
                            <asp:TextBox ID="txt_tacgia" runat="server" Width="500px" CssClass="inputtext"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: right;" class="Titlelbl">
                        ...
                        <td style="text-align: left;">
                            <asp:TextBox ID="txt_tien" runat="server" Width="188px" onkeyup="javascript:return CommaMonney(this.id);"
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <asp:Button runat="server" ID="btnXuatban" OnClick="linkPub_Click" CssClass="iconPub"
                                Text="<%$Resources:cms.language, lblXuatban%>" Font-Bold="true" />
                            <asp:Button runat="server" ID="btnTraLai" OnClick="linkTralai_Click" CssClass="iconReply"
                                Text="<%$Resources:cms.language, lblTralai%>" Font-Bold="true" />
