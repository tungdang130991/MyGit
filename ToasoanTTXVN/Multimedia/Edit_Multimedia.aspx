<%@ Page Language="C#" MasterPageFile="~/Masters/ITC.Master" AutoEventWireup="true"
    CodeBehind="Edit_Multimedia.aspx.cs" Inherits="ToasoanTTXVN.Multimedia.Edit_Multimedia"%>
                ...
                <table width="80%" align="center" cellspacing="2" cellpadding="2">
                    <tr>
                        ...
                        <td style="text-align: left;">
                            <asp:TextBox ID="txtTitle" runat="server" Width="500" CssClass="inputtext"></asp:TextBox>
                            <br />
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtTitle"
                                Display="Dynamic" ErrorMessage="<%$Resources:cms.language, msgNhaptieude%>" CssClass="req_Field" Font-Size="Small"
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">
                            <anthem:DropDownList AutoCallBack="true" ID="ddlNgonNgu" runat="server" Width="150px"
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;">
                            <asp:TextBox ID="txt_tacgia" runat="server" Width="500" CssClass="inputtext"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <asp:Button runat="server" ID="lbt_guiduyet" OnClick="linkSendPub_Click" CssClass="iconPub"
                                Text="<%$Resources:cms.language, lblGui%>" Font-Bold="true" />
