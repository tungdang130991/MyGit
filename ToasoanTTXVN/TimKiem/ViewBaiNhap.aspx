<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewBaiNhap.aspx.cs" Inherits="ToasoanTTXVN.TimKiem.ViewBaiNhap" %>
        ...
        <table cellspacing="2" cellpadding="2" width="100%" border="0">
            <tr>
                <td align="left" style="word-spacing: normal; width: 100%; padding-left: 20px; padding-right: 30px;
                    padding-top: 30px;">
                    <CKEditor:CKEditorControl ID="CKE_Noidung" Height="800px" BorderStyle="None" BasePath="~/ckeditor/"
