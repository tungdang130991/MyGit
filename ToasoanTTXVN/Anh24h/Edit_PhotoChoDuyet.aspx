<%@ Page Language="C#" MasterPageFile="~/Masters/ITC.Master" AutoEventWireup="true"
    CodeBehind="Edit_PhotoChoDuyet.aspx.cs" Inherits="ToasoanTTXVN.Anh24h.Edit_PhotoChoDuyet"%>
                ...
                <table border="0" cellpadding="1" cellspacing="1" width="100%">
                    <tr>
                        <td style="text-align: left; width: 2%">
                            <img src="../Dungchung/images/Icons/cog-edit-icon.png" alt="" width="16px"
                                height="16px" />
                        </td>
        ...
        <tr>
                ...
                <table width="100%" align="center">
                    <tr>
                        <td style="width: 20%; height: 20px; text-align: right;">
                            <a id="showModalPopupClientButton" href="#"></a><a id="hideModalPopupViaClientButton"
                                href="#"></a>
                            <asp:Label ID="Label4" runat="server" CssClass="Titlelbl" Text="<%$Resources:cms.language, lblAnpham%>"></asp:Label>(<span
                                class="req_Field">*</span>):&nbsp;
                        </td>
                        <td style="height: 20px; text-align: left;">
                            <anthem:DropDownList AutoCallBack="true" CssClass="inputtext" ID="cboNgonNgu" runat="server"
                                Width="150px">
                            </anthem:DropDownList>
                            <br />
            ...
            <tr>
                ...
                <td style="height: 20px; text-align: left;">
                    ...
                    <tr>
                        <td style="width: 20%; height: 20px; text-align: right;" class="Titlelbl">
                        ...
                        <td style="height: 20px; text-align: left;">
                            <asp:TextBox ID="txtTienNhuanBut" onKeyPress="return check_num(this,10,event);" onkeyup="javascript:return CommaMonney(this.id);"
                                runat="server" CssClass="inputtext" Width="15%" TabIndex="15"></asp:TextBox>&nbsp;&nbsp;&nbsp;VNĐ
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="center">
                            <div class="processbuttonone">
                                ...
                                <asp:Button runat="server" ID="LinkDanganh" CausesValidation="true" OnClick="LinkDanganh_Click"
                                    CssClass="iconPub" Text="<%$Resources:cms.language, lblDanganh%>" />
