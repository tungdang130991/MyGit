<%@ Page MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="~/Masters/ITC.Master"
    AutoEventWireup="true" CodeBehind="ArticleEdit.aspx.cs" Inherits="HPCApplication.Article.ArticleEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        function chitiettin() {
            ...
            var txt_sapoEdit = $('<%= txt_tomtat.ClientID %>').val();
            ...
            var cbdisplay = false;
            var _titimage = "";
            chitiet_edithpc(_bodyEdit, txt_sapoEdit, txt_TieudeEdit, tieudephu, imageThum, tacgia);
        }
    </script>
                                ...
                                <table cellspacing="4" cellpadding="4" width="100%" border="0">
                                    ...
                                    <tr>
                                        <td style="width: 20%; text-align: left">
                                            <anthem:DropDownList AutoCallBack="true" ID="cbo_lanquage" runat="server" Width="120px"
                                                Enabled="true" CssClass="inputtext" OnSelectedIndexChanged="cbo_lanquage_SelectedIndexChanged"
                                                 TabIndex="2">
                                            </anthem:DropDownList>
                                        </td>
                                        <td style="text-align: left">
                                            <anthem:DropDownList AutoCallBack="true" ID="cbo_chuyenmuc" runat="server" Width="90%"
                                    ...
                                    <tr>
                                        <td style="text-align: left" colspan="2">
                                            ...
                                            <asp:TextBox Rows="4" runat="server" ID="txt_tomtat" Height="100px" Width="91%" TextMode="MultiLine"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td style="text-align: left;">
                                            <asp:TextBox ID="txt_Author_name" runat="server" CssClass="inputtext" Width="80%"
                                                TabIndex="10"></asp:TextBox>
                                            <input runat="server" id="hdnValue" type="hidden" />
                                        </td>
                                        <td style="text-align: left;">
                                            <asp:TextBox ID="txtNguon" runat="server" CssClass="inputtext" Width="75%" TabIndex="10"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: left" class="Titlelbl" colspan="2">
                                    ...
                                    <tr>
                                        <td style="text-align: left; width: 100%" colspan="2">
                                            <asp:TextBox ID="txtTienNhuanBut" onKeyPress="return check_num(this,10,event);" onkeyup="javascript:return CommaMonney(this.id);"
                                                runat="server" CssClass="inputtext" Width="30%" TabIndex="15"></asp:TextBox>&nbsp;&nbsp;&nbsp;VNĐ
                                        </td>
                                    </tr>-->
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="text-align: left" colspan="2">
                                            <asp:TextBox ID="Txt_Comments" TabIndex="16" runat="server" Width="90%" CssClass="inputtext"
                                    ...
                                    <tr>
                                        <td align="center" colspan="2">
                                            <div class="classSearchHeader" style="width: 90%">
                                                <input type="button" id="btnViewDetails" class="iconView" 
                                                    value="<%= CommonLib.ReadXML("lblXemtruoc") %>" onclick="chitiettin();" />
                                                <asp:Button runat="server" ID="linkSave" CssClass="iconSave" TabIndex="18" OnClick="linkSave_Click"
                                                    Text="<%$Resources:cms.language, lblLuu%>"></asp:Button>
                                                <asp:Button runat="server" ID="LinkSend" CssClass="iconPub" TabIndex="19" OnClick="LinkSend_Click"
                                                    Text="<%$Resources:cms.language, lblGui%>"></asp:Button>
                                                <asp:Button runat="server" ID="btnExitForm" TabIndex="20" CssClass="iconExit" OnClick="linkExit_Click"
