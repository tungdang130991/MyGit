<%@ Page Language="C#" MasterPageFile="~/Masters/ITC.Master" AutoEventWireup="true"
    CodeBehind="PublishedEdit.aspx.cs" Inherits="ToasoanTTXVN.BaoDienTu.PublishedEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        function chitiettin() {
            ...
            //alert(CKEDITOR.instances[txt_bodyEdit].getData());
                                    ...
                                    <tr>
                                        <td align="center" colspan="2">
                                            <div class="classSearchHeader" style="width: 90%">
                                                <asp:Button runat="server" ID="btnViewDetails" CssClass="iconView" OnClientClick="chitiettin();"
                                                    Text="<%$Resources:cms.language, lblXemtruoc%>" TabIndex="17"></asp:Button>
                                                ...
                                                <asp:Button runat="server" ID="btnExitForm" TabIndex="21" CssClass="iconExit" OnClick="linkExit_Click"
