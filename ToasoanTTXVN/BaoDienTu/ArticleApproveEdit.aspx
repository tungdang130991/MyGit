<%@ Page Language="C#" MasterPageFile="~/Masters/ITC.Master" AutoEventWireup="true"
    CodeBehind="ArticleApproveEdit.aspx.cs" Inherits="ToasoanTTXVN.BaoDienTu.ArticleApproveEdit" %>
                                ...
                                <table cellspacing="4" cellpadding="4" width="100%" border="0">
                                    <tr>
                                        ...
                                        <td style="text-align: left; width: 60%" class="Titlelbl">
                                            ...
                                            <asp:Label ID="lblcm" runat="server" class="Titlelbl"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="text-align: left">
                                            <anthem:DropDownList AutoCallBack="true" ID="cbo_chuyenmuc" runat="server" Width="88%"
                                                CssClass="inputtext" DataTextField="tenchuyenmuc" DataValueField="id" TabIndex="3">
                                            </anthem:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <!-- <tr>
                                        <td style="text-align: left; padding-left: 4px;" valign="middle" class="Titlelbl"
                                            colspan="2">
                                    ...
                                    <tr>
                                        <td align="center" colspan="2">
                                            <div class="classSearchHeader" style="width: 90%">
                                                ...
                                                <asp:Button runat="server" ID="LinkSend" CssClass="iconPub" TabIndex="20" OnClick="LinkSend_Click"
