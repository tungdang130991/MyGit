<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ITC.Master" AutoEventWireup="true"
    CodeBehind="UploadLogo.aspx.cs" Inherits="ToasoanTTXVN.Danhmuc.UploadLogo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <tr>
            ...
            <td class="datagrid_top_center">
                <table border="0" cellpadding="1" cellspacing="1">
                    <tr>
                        <td>
                            <img src="../Dungchung/Images/Icons/cog-edit-icon.png" width="16px" alt="" height="16px" />
                        </td>
                        <td style="vertical-align: middle">
                            <span class="TitlePanel">CẬP NHẬT ẢNH LOGO BÁO </span>
                        </td>
                    </tr>
                </table>
            </td>
                            ...
                            <asp:DataGrid runat="server" ID="dgrListAppro" AutoGenerateColumns="false" DataKeyField="Ma_Logo"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            <div class="gallery">
                                                <div class="pictgalery" style="width: 200px;">
                                                    <img src="<%=Global.ApplicationPath%><%#Eval("Path_Logo")%>" style="width: 200px"
                                                        align="middle" onclick="return openNewImage(this, '')">
                                                </div>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn>
                                        ...
                                        <EditItemTemplate>
                                            <div class="stringtieudeandsc">
                                                <div class="fontTitle" style="width: 90%;">
                                                    <asp:TextBox ID="txtTieude" runat="server" Width="90%" Text='<%# DataBinder.Eval(Container.DataItem, "Ten_Logo")%>'></asp:TextBox>
                                                </div>
                                            </div>
                                        </EditItemTemplate>
                                    </asp:TemplateColumn>
    ...
    function() {
        $("#<%=FileUpload1.ClientID %>").fileUpload({
            ...
            'script': 'UploadFileLogo.ashx',
            'folder': 'UploadAnh/Logo',
            'fileDesc': 'Image Files',
            'fileExt': '*.jpg;*.jpeg;*.gif;*.png',
            'multi': true,
            'auto': true,
            'onComplete': function() {
                var url = '<%=Global.ApplicationPath %>/Danhmuc/UploadLogo.aspx?Menu_ID=<%=Page.Request["Menu_ID"].ToString()%>';
                window.location = url;
            }
