<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ITC.Master" AutoEventWireup="true"
    CodeBehind="AdsLogoList.aspx.cs" Inherits="ToasoanTTXVN.Quangcao.AdsLogoList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <link rel="stylesheet" href="../Dungchung/Style/Slide/css/style.css" type="text/css" media="screen" />
    <style>
        span.reference
        {
            position: fixed;
    ...
    <script language="Javascript" type="text/javascript">
        ...
        function open_window_Scroll(url, top, height, left, width) {
            var tmp_Window = window.open(url, "", "directories=no, menubar=yes,fullscreen=no,resizable=yes,toolbar=no,scrollbars=yes,statusbar=yes");
        }
    </script>
                ...
                <table border="0" cellpadding="1" cellspacing="1" style="float: left;">
                    <tr>
                        ...
                        <td style="vertical-align: middle">
                            <span class="TitlePanel"><%= CommonLib.ReadXML("titDsquangcao")%></span>
                        </td>
                    </tr>
                </table>
            </td>
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td style="width: 15%; text-align: left">
                                <asp:DropDownList ID="cbo_lanquage" runat="server" Width="150"
                                    CssClass="inputtext" TabIndex="1">
                                </asp:DropDownList>
                            </td>
                            ...
                            <td style="width: 45%; text-align: left">
                                <asp:DropDownList ID="cbo_Khachhang" runat="server" Width="40%" CssClass="inputtext"
                            ...
                            <td align="center" colspan="2">
                                <asp:DataGrid runat="server" ID="grdListCate" AutoGenerateColumns="false" DataKeyField="ID"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderText="<%$Resources:cms.language, lblQuangcao%>">
                                            <HeaderStyle HorizontalAlign="Center" Width="8%"></HeaderStyle>
                                            <ItemStyle HorizontalAlign="Center" Width="8%"></ItemStyle>
                                            <ItemTemplate>
                                                <%#ReturnObjectDisplay(Eval("Ads_Images"), Eval("Ads_ImgVideo"),Eval("ID"))%>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                        <asp:TemplateColumn HeaderText="<%$Resources:cms.language, lblMota%>">
                                            ...
                                            <ItemTemplate>
                                               ...
                                               <%-- <%#getListCategoryName(DataBinder.Eval(Container.DataItem, "ID"))%>--%>
                                        ...
                                        <asp:TemplateColumn HeaderText="<%$Resources:cms.language, lblNgaybatdau%>">
                                            <ItemTemplate>
                                                <asp:Label ID="StartDate" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Start_Date")!=System.DBNull.Value?Convert.ToDateTime(DataBinder.Eval(Container, "DataItem.Start_Date")).ToString("dd/MM/yyyy"):"" %>'>
                                                </asp:Label>
                                        ...
                                        <asp:TemplateColumn HeaderText="<%$Resources:cms.language, lblNgayketthuc%>">
                                            <ItemTemplate>
                                                <asp:Label ID="EndDate" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.End_Date")!=System.DBNull.Value?Convert.ToDateTime(DataBinder.Eval(Container, "DataItem.End_Date")).ToString("dd/MM/yyyy"):"" %>'>
                                                </asp:Label>
                                                <asp:Label ID="ID2" Visible="false" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ID")%>'>
                                                </asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" Width="6%"></HeaderStyle>
                                            <ItemStyle HorizontalAlign="Center" Width="6%"></ItemStyle>
                                        ...
                                        <asp:TemplateColumn>
                                            ...
                                            <ItemTemplate>
                                                <%#IsValidColor(Eval("HienThi"))%>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                        <asp:TemplateColumn HeaderText="<%$Resources:cms.language, lblSua%>">
                                            ...
                                            <ItemTemplate>
                                                <asp:ImageButton ID="btnEdit" Width="15px" runat="server" ImageUrl="~/Dungchung/images/edit.gif"
                                                    ImageAlign="AbsMiddle" ToolTip="<%$Resources:cms.language, lblEditads%>" CommandName="Edit"
                        ...
                        <tr>
                            <td style="width: 60%; text-align: left">
                                <asp:Button runat="server" ID="btnUpdateOrderNumber" CssClass="iconSave" CausesValidation="false"
                                    Font-Bold="true" OnClick="linkSave_Click" Text="<%$Resources:cms.language, lblLuuvitri%>"></asp:Button>
                                <%--<asp:Button runat="server" ID="btnSend" CssClass="iconPub" CausesValidation="false"
                                    Font-Bold="true" OnClick="linkSend_Click" Text="Gửi duyệt"></asp:Button>
                                <asp:Button runat="server" ID="btnXuatban" CssClass="iconPub" CausesValidation="false"
                                    Font-Bold="true" OnClick="btnXuatban_Click" Text="Xuất bản" />--%>
                                <asp:Button runat="server" ID="btnAddMenu2" CssClass="iconAddNew" CausesValidation="false"
                                    Font-Bold="true" OnClick="btnAddMenu_Click" Text="<%$Resources:cms.language, lblNhapquangcao%>"></asp:Button>
                                <asp:Button runat="server" ID="LinkDelete1" CausesValidation="false" CssClass="iconDel"
                                    Text="<%$Resources:cms.language, lblXoa%>" OnClick="btnLinkDelete_Click"></asp:Button>
                            </td>
