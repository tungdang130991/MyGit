<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ITC.Master" AutoEventWireup="true"
    CodeBehind="List_KTQC.aspx.cs" Inherits="ToasoanTTXVN.Quangcao.List_KTQC" %>
                                                            ...
                                                            <div style="float: left; width: 100%">
                                                                <asp:DataGrid ID="DataGridQC_Tralai" runat="server" Width="100%" BorderStyle="None"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateColumn HeaderText="Ngày trả">
                                                                            <ItemTemplate>
                                                                        ...
                                                                        <asp:TemplateColumn HeaderText="Người trả">
                                                                            <ItemTemplate>
                                                                                <span class="linkGridForm">
                                                                                    <%#HPCBusinessLogic.UltilFunc.GetUserFullName(DataBinder.Eval(Container.DataItem, "Nguoitao"))%></span>
                                                                            </ItemTemplate>
                                                            ...
                                                            <div style="float: left; width: 100%">
                                                                <asp:DataGrid ID="DataGridQC_Dagui" runat="server" Width="100%" BorderStyle="None"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateColumn HeaderText="Người gửi">
                                                                            <ItemTemplate>
                                                                                <span class="linkGridForm">
                                                                                    <%#HPCBusinessLogic.UltilFunc.GetUserFullName(DataBinder.Eval(Container.DataItem, "Nguoitao"))%></span>
                                                                            </ItemTemplate>
                                                ...
                                                <div style="width: 60%; text-align: left; float: left; margin-top: 10px; padding: 10px 8px;
                                                    ...
                                                    <asp:Panel ID="pnlbutton" runat="server">
                                                        <asp:LinkButton runat="server" ID="LinkSend" CausesValidation="false" OnClick="Send_Click"
                                                            OnClientClick=" return confirm('Bạn chắc chắn gửi?');" Text="Gửi duyệt" CssClass="iconSend"> </asp:LinkButton>
                                                        <asp:LinkButton runat="server" ID="LinkButtonSendDT" CausesValidation="false" OnClick="LinkButtonSendDT_Click"
                                                            OnClientClick=" return confirm('Bạn chắc chắn gửi?');" Text="Gửi DT" CssClass="iconSend"> </asp:LinkButton>
                                                        <asp:LinkButton runat="server" ID="LinkButtonBack" CausesValidation="false" OnClick="LinkButtonBack_Click"
                                                            OnClientClick=" return confirm('Bạn chắc chắn gửi?');" Text="Trả lại" CssClass="iconSend"> </asp:LinkButton>
                                                        <asp:LinkButton runat="server" ID="LinkDelete" CausesValidation="false" OnClick="Delete_Click"
                                                            OnClientClick=" return confirm('Bạn chắc chắn xóa?');" Text="Xóa" CssClass="iconDel"></asp:LinkButton>
                                                    </asp:Panel>
                                                </div>
