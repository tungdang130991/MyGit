<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ITC.Master" AutoEventWireup="true"
    CodeBehind="Edit_TTQC.aspx.cs" Inherits="ToasoanTTXVN.Quangcao.Edit_TTQC" %>
        ...
        <tr>
            <td width="100%" align="center" colspan="2">
                <table cellspacing="4" cellpadding="4" width="100%" align="left" border="0">
                    <tr>
                        <td align="right" width="10%" class="Titlelbl">
                            <span>
                                <%=CommonLib.ReadXML("lblTieude")%></span>(<span style="color: Red">*</span>):
                        </td>
                        <td align="left" width="90%" colspan="3">
                            <asp:TextBox ID="txt_tenquangcao" runat="server" Width="90%" CssClass="inputtext">
                            </asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server"
                                ControlToValidate="txt_tenquangcao" Display="Dynamic" ErrorMessage="nhập tên QC"
                                Font-Size="Small" SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" align="right" width="10%" class="Titlelbl">
                            <span>
                                <%=CommonLib.ReadXML("lblNoidung")%></span>(<span style="color: Red">*</span>):
                        </td>
                        <td align="left" width="90%" height="2" colspan="3">
                            ...
                            </CKeditor:CKEditorControl><asp:RequiredFieldValidator ID="RequiredFieldValidator10"
                                runat="server" ControlToValidate="ckeNoidung" Display="Dynamic" ErrorMessage="nhập nội dung"
                                Font-Size="Small" SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="left" width="20%">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="cboKhachhang"
                                Display="Dynamic" ErrorMessage="Chọn khách hàng QC!" InitialValue="0"></asp:RequiredFieldValidator>
                        </td>
                        <td valign="middle" align="right" width="10%" class="Titlelbl">
                            <span>
                        ...
                        <td align="left" width="20%">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="cboAnPham"
                                Display="Dynamic" ErrorMessage="Chọn ấn phẩm QC!" InitialValue="0"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" width="10%" class="Titlelbl">
                        ...
                        <td align="left" width="20%">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="cbokichthuoc"
                                Display="Dynamic" ErrorMessage="Chọn kích thước qc!" InitialValue="0"></asp:RequiredFieldValidator>
                        </td>
                        <td valign="middle" align="right" width="10%" class="Titlelbl">
                            <span>
                        ...
                        <td style="text-align: left; width: 20%">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="cboTrang"
                                Display="Dynamic" ErrorMessage="Chọn trang QC!" InitialValue="0">
