<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ITC.Master" AutoEventWireup="true"
    CodeBehind="Edit_QuangCao.aspx.cs" Inherits="ToasoanTTXVN.Quangcao.Edit_QuangCao" %>
                ...
                <table cellspacing="4" cellpadding="4" width="100%" align="left" border="0">
                    ...
                    <tr>
                        <td colspan="4" style="text-align: center">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txt_tenquangcao"
                    ...
                    <tr>
                        <td colspan="4" style="width: 100%; text-align: center">
                            ...
                            <asp:LinkButton runat="server" ID="LinkGuiDuyet" CausesValidation="true" CssClass="iconSend"
                                OnClick="linkSend_Click" Text="<%$ Resources:cms.language, lblGuiTPQC %>">
                            </asp:LinkButton>
