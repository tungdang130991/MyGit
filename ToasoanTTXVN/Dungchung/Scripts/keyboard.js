/* ********************************************************************
 **********************************************************************
 * HTML Virtual Keyboard Interface Script - v1.11
      ...
      for (var y = 0, keyid = "", ex; ex = elem[y++];) {
        if ((ex.nodeName == "TEXTAREA" || ex.type == "text" || ex.type == "password") && ex.className.indexOf("keyboardInput") > -1) {
          ...
          var keybut = document.createElement('img');
              keybut.src = "images/keyboard.gif";
              keybut.alt = "Bàn phím ảo";
              keybut.className = "keyboardInputInitiator";
              keybut.title = "Hiển thị bàn phím ảo";
              keybut.onclick = (function(a) { return function() { self.VKI_show(a); }; })(keyid);
			  ex.onfocus=(function(a) { return function() { self.VKI_onfocus(a); }; })(keyid);
			 // ex.onblur=(function(a) { return function() { self.VKI_lostfocus(a); }; })(keyid);
    ...
    var tr = document.createElement('tr');
      ...
      var td = document.createElement('td');
        var clearer = document.createElement('span');
            ...
            clearer.appendChild(document.createTextNode("Xoá"));
            clearer.title = "Xoá thông tin đã nhập";
...
this.VKI_onfocus = function(id) {
  ...
  //onblur
  this.VKI_lostfocus= function(id) {
    if (this.VKI_target = document.getElementById(id)) {
      if (this.VKI_visible != id) {
        this.VKI_range = "";
        try { this.VKI_keyboard.parentNode.removeChild(this.VKI_keyboard); } catch (e) {}
  ...
  this.VKI_position = function() {
    if (self.VKI_visible != "") {
      ...
      self.VKI_keyboard.style.left = Math.min(VKI_innerDimensions()[0] - self.VKI_keyboard.offsetWidth - 250, inputElemPos[0]) + self.VKI_target.offsetWidth + "px";
      if (this.VKI_isIE6) {
